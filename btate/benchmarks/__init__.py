...
def __getattr__(name):  # PEP 562 lazy access to the heavier submodules
    ...
    submodules = {
        ...
        "evaluate_transition_rep": "transition",
        "run_transition_sweep": "transition",
        "summarize_transition_sweep": "transition",
        "replicate_gate_table": "transition",
        "MEUQConfig": "measurement_error_uq",
        "SeedNamespaces": "measurement_error_uq",
        "GridSpec": "measurement_error_uq",
        "PopulationTargets": "measurement_error_uq",
        "MeasurementBridge": "measurement_error_uq",
        "ObservedBundle": "measurement_error_uq",
        "OracleBundle": "measurement_error_uq",
        "MethodResult": "measurement_error_uq",
        "METHODS": "measurement_error_uq",
        "DTM_METHODS": "measurement_error_uq",
        "smoke_config": "measurement_error_uq",
        "freeze_alpha_grid": "measurement_error_uq",
        "population_targets": "measurement_error_uq",
        "fit_measurement_bridge": "measurement_error_uq",
        "build_replicate": "measurement_error_uq",
        "evaluate_replicate": "measurement_error_uq",
        "multiple_imputation_band": "measurement_error_uq",
        "prepare_cell": "measurement_error_uq",
        "run_me_uq_cell": "measurement_error_uq",
        "aggregate_me_uq": "measurement_error_uq",
        "combine_shards": "measurement_error_uq",
        "algorithmic_collapse_report": "measurement_error_uq",
        "pin_blas_threads": "measurement_error_uq",
    }
